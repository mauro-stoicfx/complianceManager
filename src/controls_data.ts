export interface Control {
  ...
  specific_deadlineEn: string | null;
  responsible_person: string;
  required_evidence: string;
  required_evidenceEn: string;
...
const RAW_CONTROLS = [
  ...
  },
  {
    ...
    next_due_date: null, status: "Compliant", notes: "Cambios societarios u operativos"
  },
  {
    ...
    next_due_date: null, status: "Compliant", notes: "Designaciones de responsables clave"
  },
  {
    ...
    next_due_date: null, status: "Compliant", notes: "Estructura de oficiales de compliance"
  },
  // FSC Mauritius D1
  {
  ...
  },
  {
    ...
    next_due_date: null, status: "Compliant", notes: "Requisito de sustancia local"
  },
  {
    ...
    next_due_date: null, status: "Compliant", notes: ""
  },
  {
  ...
  },
  {
    ...
    jurisdiction: "FSC Mauritius", source_regulation: "SEM Financial Reporting Rules 2010", description: "Mantener capital adecuado >= 9 meses de gastos fijos (FEBR)",
    descriptionEn: "Maintain adequate capital >= 9 months of fixed expenses (FEBR)", frequency: "Continua", frequencyEn: "Continuous",
    specific_deadline: "Continua", specific_deadlineEn: "Continuous", responsible_person: "Mauro Serrano",
...
export const INITIAL_LOCAL_CONTROLS: Control[] = RAW_CONTROLS.map(c => ({
  id: c.id,
  domain: c.domain,
  domainEn: c.domainEn,
  ...
  specific_deadlineEn: c.specific_deadlineEn || c.specific_deadline,
